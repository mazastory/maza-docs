  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        pageId: 'maza-blog',
        title: '마자블로그 만들기',
        description: '원클릭 자체 블로그 호스팅 가이드',
        icon: Box,
      },
      {
        id: 'tistory',
      ...
      },
      {
        id: 'premium-service',
        sectionId: 'platform',
        pageId: 'premium-service',
        title: '프리미엄 블로그 제작 의뢰',
        description: '전문가의 턴키 수익화 블로그 세팅',
        icon: Sparkles,
      },
    ],
  },
    ...
    pages: [
      {
        ...
        pageId: 'niche-writer',
        title: '황금 니치 포스팅 발굴',
        description: '니치 키워드와 E-E-A-T 글쓰기 로직',
        icon: Target,
      },
      {
        id: 'blueprint-gallery',
        sectionId: 'features',
        pageId: 'blueprint-gallery',
        title: '블루프린트 갤러리',
        description: '수익화 템플릿과 전략 선택',
        icon: LayoutTemplate,
      },
      {
        id: 'autopilot',
        ...
        pageId: 'autopilot',
        title: '오토파일럿 제어 정책',
        description: '스피드/안전 모드 및 재발행 로직 제어',
        icon: Cpu,
      },
      {
        id: 'visionwriter',
      ...
      },
      {
        ...
        pageId: 'bridge',
        title: '스마트 패널 활용',
        description: 'Maza Bridge 컨텍스트 패널 사용법',
        icon: Puzzle,
      },
    ],
  },
