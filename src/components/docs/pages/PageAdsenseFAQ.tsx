...
const faqs = [
  ...
  {
    q: '애드센스 심사에서 3번 정도 거절된 도메인은 버리고 새로 만들어서 신청하는 게 맞나요?',
    a: '절대 아닙니다. 기존 도메인을 버리지 말고 그대로 고쳐서 재신청하는 것이 정답입니다. "거절 낙인"은 괴담이며, 5xx 에러나 404 리다이렉트 무한 루프 같은 기술적 오류가 원인인 경우가 대부분입니다. 에러가 수정되면 구글은 즉시 새 출발을 시켜주며, 오히려 기존 도메인의 에이징(Aging) 효과를 누리는 것이 훨씬 유리합니다.',
  },
];
